...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <div class="bg-gray-100 dark:bg-gray-900">
            <!-- Start Component Header here -->
            <x-header name="Surfside Media" :fruits="$fruits"/>
            <!-- End Component Header here -->

            <p>Description: Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aspernatur consequuntur deserunt doloremque ea, eum eveniet in, maiores maxime modi molestiae non odio pariatur porro quae quasi, quia reiciendis temporibus voluptatum!</p>
        </div>
    </body>
</html>
...
=========================================================================
    PARSE PARAMS TO VIEWS AND SHOW THEM IN THE "Header" COMPONENT
=========================================================================
